    ...
    create database webapp;
        ...
        ALTER TABLE `user_data` ADD CONSTRAINT `user_data_fk0` FOREIGN KEY (`user`) REFERENCES `user`(`id`);

        ALTER TABLE `user_data` ADD CONSTRAINT `user_data_fk1` FOREIGN KEY (`address`) REFERENCES `user_address`(`id`);
        ...
        ALTER TABLE `book` ADD CONSTRAINT `book_fk2` FOREIGN KEY (`description`) REFERENCES `book_description`(`id`);

        ALTER TABLE `recall` ADD CONSTRAINT `recall_fk0` FOREIGN KEY (`book`) REFERENCES `book`(`id`);

        ALTER TABLE `recall` ADD CONSTRAINT `recall_fk1` FOREIGN KEY (`user`) REFERENCES `user_data`(`id`);

        ALTER TABLE `shop_data` ADD CONSTRAINT `shop_data_fk0` FOREIGN KEY (`address`) REFERENCES `shop_address`(`id`);

        ALTER TABLE `shop_data` ADD CONSTRAINT `shop_data_fk1` FOREIGN KEY (`contact`) REFERENCES `shop_contact`(`id`);
